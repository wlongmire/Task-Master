  ...
  return (
    <header style={{ borderBottom: '1px solid var(--border)', background: 'var(--surface)', flexShrink: 0 }}>
      ...
      <div className="topbar-row" style={{ display: 'flex', alignItems: 'center', gap: 22, padding: '9px 28px' }}>
        <div className="hide-mobile" style={{ flex: 1, display: 'flex', alignItems: 'center', gap: 16, minWidth: 0, overflow: 'hidden' }}>
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 8, minWidth: 0, overflow: 'hidden', flexShrink: 1 }}>
            <span style={{ fontFamily: 'var(--font-nb)', fontStyle: 'italic', fontSize: 13, color: 'var(--text-dim)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>"{quote.text}"</span>
          ...
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 8, flexShrink: 0 }}>
            <a href={tarot.url} target="_blank" rel="noreferrer" style={{ fontFamily: 'var(--font-nb)', fontStyle: 'italic', fontSize: 13, color: 'var(--text-dim)', textDecoration: 'none', whiteSpace: 'nowrap', borderBottom: '1px dotted var(--text-dimmer)' }}>{tarot.name}</a>
            <span style={{ fontFamily: 'var(--font-mono)', fontStyle: 'normal', fontSize: 9, letterSpacing: '0.06em', color: 'var(--text-dimmer)', flexShrink: 0 }}>— card of the day</span>
          </div>
        </div>
